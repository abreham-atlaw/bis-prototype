...
const inventory = ref([
      { id: 1, name: 'Flour', quantity: "5 kgs" },
      { id: 2, name: 'Sugar', quantity: "2 kgs" },
      { id: 3, name: 'Egg', quantity: "3 eggs" },
      { id: 3, name: 'Milk', quantity: "2 ltr" },
      { id: 3, name: 'Vegetable Oil', quantity: "4 ltr" },
    ]);

const products = ref([
  { id: 1, name: 'Bread Type 1', quantity: "5000" },
  { id: 2, name: 'Muffins', quantity: "2000" },
  { id: 3, name: 'Black Forest Cake', quantity: "1000" },
  { id: 3, name: 'Bread Type 2', quantity: "900" },
  { id: 3, name: 'Baklava', quantity: "500" },
]);
